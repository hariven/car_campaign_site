...
const HomePage: React.FC = () => {
  ...
  return (
    ...
    <nav aria-label="main-content">
      {/* Hero Section */}
      <section id="hero" aria-hidden="true" className="relative pt-16 min-h-screen flex items-center">
        <div
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              Discover exclusive deals on premium vehicles. Join thousands of satisfied
              customers who found their perfect car with us.
            </motion.p>
            <motion.div
              initial={{ y: 30, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto">
              We provide the best car buying experience with unmatched service and premium vehicles.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Our experienced team guides you through every step of your car buying journey.",
              },
              {
                icon: CheckCircle,
                title: "Best Deals",
                description: "Competitive pricing and exclusive offers you won't find anywhere else.",
              },
            ].map((feature, index) => (
              <Card className="text-center hover:shadow-lg transition-shadow h-full">
  <div role="group" aria-labelledby={`feature-${index}`} className="px-4 pt-6">
    <motion.div
      initial={{ scale: 0 }}
      whileInView={{ scale: 1 }}
    ...
    <h6 className="font-heading text-lg font-semibold">{feature.title}</h6>
  </div>
  <CardContent>
    <p className="font-body text-muted-foreground">{feature.description}</p>
      ...
      {/* Registration Form */}
      <section id="registration-form" aria-labelledby="registration-form-heading" className="bg-gray-100 py-20">
      ...
      {/* Footer */}
      <motion.footer
      role="contentinfo" aria-label="Website footer"
        initial={{ y: 50, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center">
            <p className="font-body text-primary-foreground/80">© 2025 DreamCars. All rights reserved.</p>
          </div>
        </div>
      </motion.footer>
    </div>
